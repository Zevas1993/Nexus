...
class WeatherService:
    ...
    def __init__(self, config=None):
        ...
        self.api_key = os.getenv("OPENWEATHER_API_KEY", self.config.get("OPENWEATHER_API_KEY", ""))
        ...
        try:
            ...
            if not self.api_key:
                return {
                    ...
                    "text": "I'm sorry, but the weather service is not properly configured. Please set up an OpenWeather API key."
                }
